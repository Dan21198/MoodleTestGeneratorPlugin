...
class openrouter_client {
    ...
    public function __construct() {
        $this->apikey = get_config('local_quizgen', 'openrouter_api_key');
        $this->model = $this->get_configured_model();
        $this->timeout = get_config('local_quizgen', 'openrouter_timeout') ?: 60;
        $this->maxretries = get_config('local_quizgen', 'max_retries') ?: 3;
        $this->maxtokens = get_config('local_quizgen', 'max_tokens') ?: 2000;
    ...
    private function get_configured_model() {
        $model = get_config('local_quizgen', 'openrouter_model') ?: 'openai/gpt-4o-mini';

        if ($model === 'other') {
            $custommodel = get_config('local_quizgen', 'openrouter_model_custom');
